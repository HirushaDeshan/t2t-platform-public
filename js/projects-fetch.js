  ...
  const projectsToDisplay = data.records.slice(startIndex, endIndex);
    ...
    projectsToDisplay.forEach(project => {
      ...
      const detailItems = [
        ...
        { icon: 'fas fa-bullseye', label: 'Goal', value: toSentenceCase(project.Goal) },
        { icon: 'fas fa-tasks', label: 'Tasks', value: toSentenceCase(project.Tasks) },
      ...
      bidButton.addEventListener('click', function() {
        ...
        window.location.href = `expression-of-interest.html?Project_Title=${encodeURIComponent(titleValue)}`;
      });
